...
class Upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error']                  = __('File error. Please try again.');
        $this->translation['local_file_missing']          = __('Local file doesn\'t exist.');
        $this->translation['local_file_not_readable']     = __('Local file is not readable.');
        $this->translation['uploaded_too_big_ini']        = __('File upload error (the uploaded file exceeds the upload_max_filesize directive in php.ini).');
        $this->translation['uploaded_too_big_html']       = __('File upload error (the uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the html form).');
        $this->translation['uploaded_partial']            = __('File upload error (the uploaded file was only partially uploaded).');
        $this->translation['uploaded_missing']            = __('File upload error (no file was uploaded).');
        $this->translation['uploaded_no_tmp_dir']         = __('File upload error (missing a temporary folder).');
        $this->translation['uploaded_cant_write']         = __('File upload error (failed to write file to disk).');
        $this->translation['uploaded_err_extension']      = __('File upload error (file upload stopped by extension).');
        $this->translation['uploaded_unknown']            = __('File upload error (unknown error code).');
        $this->translation['try_again']                   = __('File upload error. Please try again.');
        $this->translation['file_too_big']                = __('File too big.');
        $this->translation['no_mime']                     = __('MIME type can\'t be detected.');
        $this->translation['incorrect_file']              = __('Incorrect type of file.');
        $this->translation['image_too_wide']              = __('Image too wide.');
        $this->translation['image_too_narrow']            = __('Image too narrow.');
        $this->translation['image_too_high']              = __('Image too tall.');
        $this->translation['image_too_short']             = __('Image too short.');
        $this->translation['ratio_too_high']              = __('Image ratio too high (image too wide).');
        $this->translation['ratio_too_low']               = __('Image ratio too low (image too high).');
        $this->translation['too_many_pixels']             = __('Image has too many pixels.');
        $this->translation['not_enough_pixels']           = __('Image has not enough pixels.');
        $this->translation['file_not_uploaded']           = __('File not uploaded. Can\'t carry on a process.');
        $this->translation['already_exists']              = __('%s already exists. Please change the file name.');
        $this->translation['temp_file_missing']           = __('No correct temp source file. Can\'t carry on a process.');
        $this->translation['source_missing']              = __('No correct uploaded source file. Can\'t carry on a process.');
        $this->translation['destination_dir']             = __('Destination directory can\'t be created. Can\'t carry on a process.');
        $this->translation['destination_dir_missing']     = __('Destination directory doesn\'t exist. Can\'t carry on a process.');
        $this->translation['destination_path_not_dir']    = __('Destination path is not a directory. Can\'t carry on a process.');
        $this->translation['destination_dir_write']       = __('Destination directory can\'t be made writeable. Can\'t carry on a process.');
        $this->translation['destination_path_write']      = __('Destination path is not a writeable. Can\'t carry on a process.');
        $this->translation['temp_file']                   = __('Can\'t create the temporary file. Can\'t carry on a process.');
        $this->translation['source_not_readable']         = __('Source file is not readable. Can\'t carry on a process.');
        $this->translation['no_create_support']           = __('No create from %s support.');
        $this->translation['create_error']                = __('Error in creating %s image from source.');
        $this->translation['source_invalid']              = __('Can\'t read image source. Not an image?.');
        $this->translation['gd_missing']                  = __('GD doesn\'t seem to be present.');
        $this->translation['watermark_no_create_support'] = __('No create from %s support, can\'t read watermark.');
        $this->translation['watermark_create_error']      = __('No %s read support, can\'t create watermark.');
        $this->translation['watermark_invalid']           = __('Unknown image format, can\'t read watermark.');
        $this->translation['file_create']                 = __('No %s create support.');
        $this->translation['no_conversion_type']          = __('No conversion type defined.');
        $this->translation['copy_failed']                 = __('Error copying file on the server. copy() failed.');
        $this->translation['reading_failed']              = __('Error reading the file.');
