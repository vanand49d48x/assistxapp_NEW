...
<?php include '../sidebar.php'; ?>
            ...
            <div class="quick-card card">
                <div class="card-body">
                    <div class="dataTables_wrapper">
                        <table class="table table-striped" id="ajax_datatable" data-jsonfile="ai_chat_prompts.php" data-reorder-action="aiChatPromptsPosition" data-order-dir="asc">
                            <thead>
                            <tr>
                                <th width="20"></th>
                                <th><?php _e('Title') ?></th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="deleteAIChatPrompts"
                    class="btn btn-danger btn-floating animation-slide-bottom">
                <i class="icon icon-feather-trash-2" aria-hidden="true"></i>
            </button>
        </div>
        <button type="button" class="front-icon btn btn-primary btn-floating" data-url="panel/ai_chat_prompts.php" data-toggle="slidePanel">
    ...
    <script>
        var QuickMenu = {"page":"ai-chat-prompts"};
    </script>
